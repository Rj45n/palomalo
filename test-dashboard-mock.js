...
const testDashboard = async () => {
  ...
  console.log("🧪 TEST DASHBOARD - PHASE 2 (MOCK)");
  console.log("=".repeat(60));
  ...
  try {
    ...
    // Étape 2: Récupérer les métriques mockées
    console.log("\n📡 Étape 2: Récupération des métriques (mock)");
    const metricsResponse = await fetch("http://localhost:3000/api/metrics-mock", {
      headers: {
        Cookie: `${apiKey}; ${url}`,
      },
    });
